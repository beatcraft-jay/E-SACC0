...
function Settings() {
 ...
 <h1 className="display-6 mb-4">Settings</h1>
 ...
 <Accordion.Header>
 <BsPerson size={20} className="me-2" /> Profile Information
 </Accordion.Header>
 ...
 <Accordion.Header>
 <BsEnvelope size={20} className="me-2" /> Notification Preferences
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 ...
 <Accordion.Header>
 <BsGlobe size={20} className="me-2" /> Currency
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 <Form onSubmit={handlePreferencesSubmit}>
 <Form.Group className="mb-3">
 ...
 <Accordion.Header>
 <BsCreditCard size={20} className="me-2" /> Payment Options
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 <Form onSubmit={ handlePreferencesSubmit}>
 <Form.Group className="mb-3">
 ...
 <Accordion.Header>
 <BsUniversalAccess size={20} className="me-2" /> Accessibility
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 <Form onSubmit={handlePreferencesSubmit}>
 <Form.Group className="mb-3">
 ...
 {preferences.theme === 'light' ? <BsSun size={20} /> : <BsMoon size={20} />}
 ...
 <Accordion.Header>
 <BsLock size={20} className="me-2" /> Security
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 ...
 <Accordion.Header>
 <BsQuestionCircle size={20} className="me-2" /> Help
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 <p>
 <a href="/faq" className="text-primary">Visit our FAQ</a> for common questions.
 </p>
 <p>
 Contact support via <a href="/forum" className="text-primary">Support Messages</a> or email us at{' '}
 ...
 <Accordion.Header>
 <BsShare size={20} className="me-2" /> Invite a Friend
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 ...
 <Accordion.Header>
 <BsArrowClockwise size={20} className="me-2" /> App Updates
 </Accordion.Header>
 <Accordion.Body  className='accordion'>
 <Form onSubmit={handlePreferencesSubmit}>
 <Form.Check
 ...
 <Accordion.Header>
 <BsInfoCircle size={20} className="me-2" /> About
 </Accordion.Header>
 <Accordion.Body className='accordion'>
 <h6>E-SACCO</h6>
 <p><strong>Version:</strong> 1.0.0</p>
 <p><strong>Creator:</strong> Beatcraft</p>
 <p><strong>Description:</strong> E-SACCO is a digital platform designed to empower SACCO members with seamless financial management, including loans, savings, and community engagement.</p>
 <p><strong>Contact:</strong> <a href="mailto:support@esacco.com" className="text-primary">support@esacco.com</a> or <a href="/forum" className="text-primary">Support Messages</a></p>
 <p><strong>License:</strong> MIT License</p>
 <p><strong>Learn More:</strong> <a href="https://x.com/_todii" target="_blank" rel="noopener noreferrer" className="text-primary">Visit xAI</a></p>
 </Accordion.Body>
 </Accordion.Item>
 </Accordion>
 </Card.Body>
