        ...
        <div class='row border rounded-3 bg-white shadow box-area'>
            <div class=" rounded-4 left-box" className='bg'>
                <div class="bg d-flex align-items-center justify-content-center flex-column">
                    ...
                    <p class="fs-2 mt-4 main-text">Welcome</p>
                    <small class="text-wrap text-center text-primary small-text">Dream big, save smart.</small>
                </div>
            </div>
            ...
            <div class="bg col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" placeholder="Email / Phone" class="fs-6 form-control border-top-0 border-end-0 border-start-0 border border-2 main-text" id="exampleInputEmail1" aria-describedby="emailHelp"/>
                    </div>
                    <div class="input-group mb-1">
                        <input type={type} placeholder="Password" class="fs-6 form-control border-top-0 border-end-0 border-start-0 border border-2 main-text" id="exampleInputPassword1"/>
                        <span onClick={handleToggle}><i class={icon} ></i></span>
                    </div>
